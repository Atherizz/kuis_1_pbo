...
public class Main {
        public static void main(String[] args) {
                ...
                Instruktur instruktur1 = new Instruktur("andi123", "andi@mail.com", "passA", "Andi",
                                "Pemrograman Java");
                ...
                daftarKursus.add(new Kursus(1, "Belajar Java Dasar", new MataPelajaran(1, "Java Dasar"), instruktur1,
                                true));
                daftarKursus.add(new Kursus(2, "Belajar Java Lanjutan", new MataPelajaran(2, "Java Lanjutan"),
                                instruktur1, true));
                daftarKursus.add(new Kursus(3, "UI/UX untuk Pemula", new MataPelajaran(3, "UI/UX Dasar"), instruktur2,
                                false));
                daftarKursus.add(new Kursus(4, "Membangun Mobile App", new MataPelajaran(4, "Desain Mobile App"),
                                instruktur2, true));
                daftarKursus.add(new Kursus(5, "Database MySQL Praktis", new MataPelajaran(5, "Database MySQL"),
                                instruktur1, true));
                daftarKursus.add(new Kursus(6, "Algoritma & Pemrograman", new MataPelajaran(6, "Algoritma Pemrograman"),
                                instruktur1, false));
                daftarKursus.add(new Kursus(7, "Frontend dengan React", new MataPelajaran(7, "React Frontend"),
                                instruktur2, true));
                daftarKursus.add(new Kursus(8, "Backend dengan Spring Boot",
                                new MataPelajaran(8, "Spring Boot Backend"), instruktur1, true));
                daftarKursus.add(new Kursus(9, "Machine Learning Dasar", new MataPelajaran(9, "Machine Learning Dasar"),
                                instruktur1, true));
                daftarKursus.add(new Kursus(10, "UI/UX Prototyping", new MataPelajaran(10, "UI/UX Prototyping"),
                                instruktur2, true));
                ...
                Artikel c8 = new Artikel(8, "Artikel: REST API Spring Boot", k8,
                                "Controller, service, repository pattern",
                                k8.getInstruktur().getNama());
                k8.getDaftarKonten().add(c8);

                Kursus k9 = daftarKursus.get(8);
                Video c9 = new Video(9, "Video: ML untuk Pemula", k9, "Supervised vs unsupervised, dataset & metric",
                                900);
